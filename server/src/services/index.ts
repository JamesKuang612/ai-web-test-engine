...
import { PlanGenerationService } from './plan_generation.service';
...
registerSvc(PlanGenerationService);
...
export const planGenerationService = getSvc<PlanGenerationService>(
